defmodule Astra.HttpBase do
  ...
  def find_base(config, false), do: "https://#{config[:id]}-#{config[:region]}.apps.astra.datastax.com"
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      def parse_response({:ok, %HTTPoison.Response{status_code: 404}}), do: {:rejected, "bad URL"}
